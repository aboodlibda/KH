                                    ...
                                    @foreach($allPosts as $post)
                                        <li class="col-sm-6 pbottom--30">
                                            ...
                                            <div class="post--item post--layout-1">
                                                <div class="post--img">
                                                    <a href="{{route('posts.show',$post->id)}}" class="thumb"><img src="{{asset('postsImages/'.$post->image)}}" style="    width: 300px;height: 300px;" alt="" data-rjs="2" data-rjs-processed="true"></a>
                                                    ...
                                                    <div class="post--info">
                                                        <ul class="nav meta">
                                                            ...
                                                            <li><a href="{{route('posts.show',$post->id)}}">{{$post->created_at->diffForHumans()}}</a> </li>
                                                        </ul>

                                                        <div class="title">
                                                            <h3 class="h4"><a href="{{route('posts.show',$post->id)}}" class="btn-link">{{ Str::limit($post->title ,50)}}</a></h3>
                                                        </div>
                                                    </div>
                                                </div>

                                                <div class="post--action">
                                                    <a href="{{route('posts.show',$post->id)}}">عرض المزيد ... </a>
                                                </div>
                                            </div>
                                            <!-- Post Item End -->
                                        </li>
