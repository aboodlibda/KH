        ...
        <div class="col-lg-12">
            <div class="card">
                <ul class="nav nav-tabs">
                    <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#addPost">Edit Projects</a></li>
                </ul>
                            ...
                            <form action="{{route('projects.update',[$project->id])}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="form-group">
                                            <textarea class="form-control" required="required" name="description" cols="50" rows="10" id="description">{!! $project->description !!}</textarea>
                                            @error('description')
                                    ...
                                    <span class="input-group-btn">
                                        <span class="btn btn-default btn-file">
                                           Browse
                                            ...
                                            <img id='img-upload' src="{{asset('projects_images/'.$project->image)}}" />
                                        </div>
                                    </div>
                                </div>
