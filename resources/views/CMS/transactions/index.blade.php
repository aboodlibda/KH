...
@section('content')
    ...
    @if (session()->has('transaction_added'))
        ...
        <script>
            window.onload = function () {
                notif({
                    msg: "Transactions Added Successfully",
                    type: "success"
                });
            }
        </script>
    ...
    @if (session()->has('transaction_deleted'))
    ...
    @if (session()->has('transaction_updated'))
        ...
        <div class="col-lg-12">
            <div class="card">
                <ul class="nav nav-tabs">
                    ...
                    <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#addMenu">Add Transactions</a></li>
                </ul>
<br>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a  data-effect="effect-scale"
                                                data-id="{{ $transaction->id }}" data-title="{{ $transaction->title }}" data-toggle="modal"
                                                href="#modaldemo9" >
                                              <span class="btn btn-sm btn-default">
    ...
    <div class="modal" id="modaldemo9">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content modal-content-demo">
                ...
                <form action="transactions/destroy" method="post">
                    {{method_field('delete')}}
                    {{csrf_field()}}
                    <div class="modal-body">
                        <p>Are you sure to delete this Transaction?</p><br>
