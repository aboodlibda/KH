...
@endphp
@if(isset($comment->commenter->id))

<div id="comment-{{ $comment->getKey() }}" class="media">

    <img class="mr-3 img-fluid rounded"  src="{{$comment->commenter->image == 'user.png' ? asset('user.png') : asset('usersImages/'.($comment->commenter->image)) }}" style="width: 60px;height: 60px">
